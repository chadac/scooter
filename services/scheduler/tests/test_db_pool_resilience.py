"""The scheduler's async DB engine must survive a postgres restart / failover / idle-timeout.
...
ENGINE_MODULES = [Path(__file__).resolve().parents[1] / "scheduler/store.py"]
